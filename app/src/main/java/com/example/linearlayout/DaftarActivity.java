    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    //Membuat kondisi untuk mengecek apakah isi dari EditText password dan EditText rePass sama atau tidak
                    if (edtPassword.getText().toString().equals(edtrePass.getText().toString()))
                    {
                        //Menampilkan notif jika pendaftaran berhasil
...
//                      //Methode untuk kembali ke activity Main
                    ...
                    {
                        //Menampilkan pesan bahwa isi dari EditText password dan EditText rePass tidak sama
